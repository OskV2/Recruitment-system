                                ...
                                <li class="admin__collapse-item">
                                    <div class="row d-flex admin__collapse-item-ab">
                                        ...
                                        <div class="col-3 admin__collapse-item-ab-form">
                                            <a href="../templates_sql/fire_employee.php?App_Id=<?php echo $rows['App_Id']; ?>" class="btn btn-outline-alert" target="_blank">Zwolnij pracownika</a>
                                        </div>
                                    </div>
                            ...
                            if ($rows2['Status'] == '5'): ?>
                                <li class="admin__collapse-item">
                                    <div class="row d-flex admin__collapse-item-ab">
                                        ...
                                        <div class="col-3 admin__collapse-item-ab-form">
                                            <a href="../templates_sql/fire_employee.php?App_Id=<?php echo $rows2['App_Id']; ?>" class="btn btn-outline-alert" target="_blank">Usuń Kandydata</a>
                                        </div>
                                    </div>
